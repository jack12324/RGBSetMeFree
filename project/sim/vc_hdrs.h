...
struct	_vcs_dpi_ase_cfg_t	{
 ...
 extern void rd_memline_req_dex(/* INOUT */cci_pkt *pkg);

 extern void rd_memline_rsp_dex(/* INOUT */cci_pkt *pkg);

 extern void wr_memline_req_dex(/* INOUT */cci_pkt *pkg);

 extern void wr_memline_rsp_dex(/* INOUT */cci_pkt *pkg);
 ...
 extern void mmio_dispatch(/* INPUT */int initialize, const /* INPUT */mmio_t *mmio_pkt);

 extern void umsg_dispatch(/* INPUT */int init, const /* INPUT */umsgcmd_t *umsg_pkt);

 extern void ase_config_dex(const /* INPUT */ase_cfg_t *cfg_in);
